#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_new_deals_ndf_fwd_start — o bloco `new deals/NDF/FWD Start` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/new deals/NDF/FWD Start (arquivo-dia)',
                 conversores=('daily',), familias=['new deals/NDF/FWD Start'],
                 doc=__doc__))
