#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_daily_settlement_operacoes_mgt — o bloco `daily settlement/operacoes-mgt` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/daily settlement/operacoes-mgt (arquivo-dia)',
                 conversores=('daily',), familias=['daily settlement/operacoes-mgt'],
                 doc=__doc__))
