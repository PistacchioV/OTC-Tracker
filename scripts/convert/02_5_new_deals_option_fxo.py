#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_new_deals_option_fxo — o bloco `new deals/Option/FXO` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/new deals/Option/FXO (arquivo-dia)',
                 conversores=('daily',), familias=['new deals/Option/FXO'],
                 doc=__doc__))
