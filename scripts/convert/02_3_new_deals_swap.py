#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_new_deals_swap — o bloco `new deals/Swap` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/new deals/Swap (arquivo-dia)',
                 conversores=('daily',), familias=['new deals/Swap'],
                 doc=__doc__))
