#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 01_tickets — a pasta de cadastro `tickets/`.

O ESCOPO é UMA pasta de cadastro do DATA_DIR: **tickets/**.

O store do Support Center.

É UM BANCO POR ARQUIVO, na mesma árvore do JSON: db/tickets/<arquivo>.db, com
...
if __name__ == '__main__':
    sys.exit(run(escopo='tickets/ (um banco por arquivo)',
                 conversores=('datasets',), pastas=['tickets'],
                 doc=__doc__))
