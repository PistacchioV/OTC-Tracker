#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 01_mappings — a pasta de cadastro `mappings/`.

O ESCOPO é UMA pasta de cadastro do DATA_DIR: **mappings/**.

Os 43 cadastros do /mapping — um banco por cadastro.

É UM BANCO POR ARQUIVO, na mesma árvore do JSON: db/mappings/<arquivo>.db, com
...
if __name__ == '__main__':
    sys.exit(run(escopo='mappings/ (um banco por arquivo)',
                 conversores=('datasets',), pastas=['mappings'],
                 doc=__doc__))
