#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_b3_files_option — o bloco `b3 files/Option` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/b3 files/Option (arquivo-dia)',
                 conversores=('daily',), familias=['b3 files/Option'],
                 doc=__doc__))
