#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_daily_settlement_otm_settlement — o bloco `daily settlement/otm-settlement` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/daily settlement/otm-settlement (arquivo-dia)',
                 conversores=('daily',), familias=['daily settlement/otm-settlement'],
                 doc=__doc__))
