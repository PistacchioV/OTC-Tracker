#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_new_deals_swap_rates — o bloco `new deals/Swap/Rates` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/new deals/Swap/Rates (arquivo-dia)',
                 conversores=('daily',), familias=['new deals/Swap/Rates'],
                 doc=__doc__))
