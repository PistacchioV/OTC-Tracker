#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_new_deals_option_commodities — o bloco `new deals/Option/Commodities` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/new deals/Option/Commodities (arquivo-dia)',
                 conversores=('daily',), familias=['new deals/Option/Commodities'],
                 doc=__doc__))
