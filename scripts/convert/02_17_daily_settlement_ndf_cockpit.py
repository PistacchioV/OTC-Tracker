#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_daily_settlement_ndf_cockpit — o bloco `daily settlement/ndf-cockpit` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/daily settlement/ndf-cockpit (arquivo-dia)',
                 conversores=('daily',), familias=['daily settlement/ndf-cockpit'],
                 doc=__doc__))
