#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_b3_files_operations — o bloco `b3 files/Operations` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/b3 files/Operations (arquivo-dia)',
                 conversores=('daily',), familias=['b3 files/Operations'],
                 doc=__doc__))
