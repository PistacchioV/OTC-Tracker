#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_new_deals_ndf_vanilla — o bloco `new deals/NDF/Vanilla` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/new deals/NDF/Vanilla (arquivo-dia)',
                 conversores=('daily',), familias=['new deals/NDF/Vanilla'],
                 doc=__doc__))
