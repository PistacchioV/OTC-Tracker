#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_new_deals_intrag_ndf — o bloco `new deals/Intrag/NDF` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/new deals/Intrag/NDF (arquivo-dia)',
                 conversores=('daily',), familias=['new deals/Intrag/NDF'],
                 doc=__doc__))
