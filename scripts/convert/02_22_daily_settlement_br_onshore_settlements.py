#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_daily_settlement_br_onshore_settlements — o bloco `daily settlement/br-onshore-settlements` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/daily settlement/br-onshore-settlements (arquivo-dia)',
                 conversores=('daily',), familias=['daily settlement/br-onshore-settlements'],
                 doc=__doc__))
