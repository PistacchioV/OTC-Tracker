#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_new_deals_ndf_fwdstart — o bloco `new deals/NDF/FwdStart` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/new deals/NDF/FwdStart (arquivo-dia)',
                 conversores=('daily',), familias=['new deals/NDF/FwdStart'],
                 doc=__doc__))
