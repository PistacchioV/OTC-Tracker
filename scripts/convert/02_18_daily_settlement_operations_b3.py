#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_daily_settlement_operations_b3 — o bloco `daily settlement/operations-b3` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/daily settlement/operations-b3 (arquivo-dia)',
                 conversores=('daily',), familias=['daily settlement/operations-b3'],
                 doc=__doc__))
