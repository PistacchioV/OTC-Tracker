#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_daily_settlement_other_products_summary — o bloco `daily settlement/other-products-summary` de cache/.

O ESCOPO é UM bloco de cache/: **daily settlement/other-products-summary**.

O Other Products Summary — e o
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/daily settlement/other-products-summary (arquivo-dia)',
                 conversores=('daily',), familias=['daily settlement/other-products-summary'],
                 doc=__doc__))
