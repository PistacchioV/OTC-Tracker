#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_new_deals_intrag_swap — o bloco `new deals/Intrag/Swap` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/new deals/Intrag/Swap (arquivo-dia)',
                 conversores=('daily',), familias=['new deals/Intrag/Swap'],
                 doc=__doc__))
