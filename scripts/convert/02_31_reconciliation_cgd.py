#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_reconciliation_cgd — o bloco `reconciliation/cgd` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/reconciliation/cgd (arquivo-dia)',
                 conversores=('daily',), familias=['reconciliation/cgd'],
                 doc=__doc__))
