#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 02_new_deals_intrag — o bloco `new deals/Intrag` de cache/.
...
if __name__ == '__main__':
    sys.exit(run(escopo='cache/new deals/Intrag (arquivo-dia)',
                 conversores=('daily',), familias=['new deals/Intrag'],
                 doc=__doc__))
