#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""convert 01_file_interpreter — a pasta de cadastro `file-interpreter/`.

O ESCOPO é UMA pasta de cadastro do DATA_DIR: **file-interpreter/**.

Os templates e variantes do File Interpreter.

É UM BANCO POR ARQUIVO, na mesma árvore do JSON: db/file-interpreter/<arquivo>.db, com
...
if __name__ == '__main__':
    sys.exit(run(escopo='file-interpreter/ (um banco por arquivo)',
                 conversores=('datasets',), pastas=['file-interpreter'],
                 doc=__doc__))
