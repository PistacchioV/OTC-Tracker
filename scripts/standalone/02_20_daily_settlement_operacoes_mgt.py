#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_daily_settlement_operacoes_mgt — a rotina `daily settlement/operacoes-mgt` de cache/.
...
Uso:
    ...
    python 02_20_daily_settlement_operacoes_mgt.py --dry-run
    python 02_20_daily_settlement_operacoes_mgt.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"

O ESCOPO é UM bloco de cache\: **daily settlement/operacoes-mgt**.
...
def main(argv=None):
    ...
    print('escopo : cache/daily settlement/operacoes-mgt (arquivo-dia)')
    ...
    fatia = 'daily settlement/operacoes-mgt'
    if args.bloco:
