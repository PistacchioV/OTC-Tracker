#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_reconciliation_payrec — a rotina `reconciliation/payrec` de cache/.

Os caches por data da reconciliação de Pay/Rec —
...
Uso:
    ...
    python 02_32_reconciliation_payrec.py --dry-run
    python 02_32_reconciliation_payrec.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"

O ESCOPO é UM bloco de cache\: **reconciliation/payrec**.
...
def main(argv=None):
    ...
    print('escopo : cache/reconciliation/payrec (arquivo-dia)')
