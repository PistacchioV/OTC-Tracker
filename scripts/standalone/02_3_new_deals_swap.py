#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_new_deals_swap — a rotina `new deals/Swap` de cache/.

Os swaps do New Deals — Rates e Commodities.
...
Uso:
    python 02_3_new_deals_swap.py
    python 02_3_new_deals_swap.py --dry-run
    python 02_3_new_deals_swap.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"

O ESCOPO é UM bloco de cache\: **new deals/Swap**.
...
def main(argv=None):
    ...
    print('escopo : cache/new deals/Swap (arquivo-dia)')
