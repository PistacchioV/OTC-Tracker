#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_new_deals_ndf — a rotina `new deals/NDF` de cache/.
...
Uso:
    python 02_1_new_deals_ndf.py
    python 02_1_new_deals_ndf.py --dry-run
    python 02_1_new_deals_ndf.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/new deals/NDF (arquivo-dia)')
