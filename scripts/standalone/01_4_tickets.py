#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 01_tickets — a pasta de cadastro `tickets`.

O store do Support Center.
...
Uso:
    ...
    python 01_4_tickets.py --dry-run
    python 01_4_tickets.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"

O ESCOPO é UMA pasta de cadastro do DATA_DIR: **tickets\**.

O store do Support Center.

É UM BANCO POR ARQUIVO, na mesma árvore do JSON (db\tickets\<arquivo>.db),
...
def main(argv=None):
    ...
    print('escopo : tickets/ (um banco por arquivo)')
