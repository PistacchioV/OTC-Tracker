#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_b3_files — a rotina `b3 files` de cache/.
...
Uso:
    python 02_2_b3_files.py
    python 02_2_b3_files.py --dry-run
    python 02_2_b3_files.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/b3 files (arquivo-dia)')

    houve_erro = [False]
    _resumo('daily', convert_daily(data_dir, out_dir, force=args.force,
                                   dry_run=args.dry_run, familias=['b3 files']),
            houve_erro)
