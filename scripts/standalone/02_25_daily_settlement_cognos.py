#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_daily_settlement_cognos — a rotina `daily settlement/cognos` de cache/.
...
Uso:
    ...
    python 02_25_daily_settlement_cognos.py --dry-run
    python 02_25_daily_settlement_cognos.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"

O ESCOPO é UM bloco de cache\: **daily settlement/cognos**.
...
def main(argv=None):
    ...
    print('escopo : cache/daily settlement/cognos (arquivo-dia)')
