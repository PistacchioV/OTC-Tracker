#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_daily_settlement_eventos_swap_mgt — a rotina `daily settlement/eventos-swap-mgt` de cache/.
...
Uso:
    ...
    python 02_22_daily_settlement_eventos_swap_mgt.py --dry-run
    python 02_22_daily_settlement_eventos_swap_mgt.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/daily settlement/eventos-swap-mgt (arquivo-dia)')
    ...
    fatia = 'daily settlement/eventos-swap-mgt'
    if args.bloco:
