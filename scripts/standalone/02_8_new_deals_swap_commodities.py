#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_new_deals_swap_commodities — a rotina `new deals/Swap/Commodities` de cache/.
...
Uso:
    ...
    python 02_8_new_deals_swap_commodities.py --dry-run
    python 02_8_new_deals_swap_commodities.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/new deals/Swap/Commodities (arquivo-dia)')
    ...
    fatia = 'new deals/Swap/Commodities'
    if args.bloco:
