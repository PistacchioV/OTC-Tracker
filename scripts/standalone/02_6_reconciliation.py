...
Uso:
    python 02_6_reconciliation.py
    python 02_6_reconciliation.py --dry-run
    python 02_6_reconciliation.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    _resumo('daily', convert_daily(data_dir, out_dir, force=args.force,
                                   dry_run=args.dry_run, familias=['reconciliation']),
            houve_erro)
