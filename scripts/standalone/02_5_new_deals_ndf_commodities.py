#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_new_deals_ndf_commodities — a rotina `new deals/NDF/Commodities` de cache/.
...
Uso:
    ...
    python 02_5_new_deals_ndf_commodities.py --dry-run
    python 02_5_new_deals_ndf_commodities.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/new deals/NDF/Commodities (arquivo-dia)')
    ...
    fatia = 'new deals/NDF/Commodities'
    if args.bloco:
