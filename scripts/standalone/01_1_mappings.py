#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 01_mappings — a pasta de cadastro `mappings`.

Os 43 cadastros do /mapping — um banco por cadastro.
...
Uso:
    ...
    python 01_1_mappings.py --dry-run
    python 01_1_mappings.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"

O ESCOPO é UMA pasta de cadastro do DATA_DIR: **mappings\**.

Os 43 cadastros do /mapping — um banco por cadastro.

É UM BANCO POR ARQUIVO, na mesma árvore do JSON (db\mappings\<arquivo>.db),
...
def main(argv=None):
    ...
    print('escopo : mappings/ (um banco por arquivo)')
