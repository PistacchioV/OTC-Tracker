#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_new_deals_intrag — a rotina `new deals/Intrag` de cache/.

Os arquivo-dia da Intrag — NDF e Opção.
...
Uso:
    python 02_4_new_deals_intrag.py
    python 02_4_new_deals_intrag.py --dry-run
    python 02_4_new_deals_intrag.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"

O ESCOPO é UM bloco de cache\: **new deals/Intrag**.
...
def main(argv=None):
    ...
    print('escopo : cache/new deals/Intrag (arquivo-dia)')
