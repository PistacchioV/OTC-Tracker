#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_daily_settlement_eventos_swap_jpm — a rotina `daily settlement/eventos-swap-jpm` de cache/.
...
Uso:
    ...
    python 02_21_daily_settlement_eventos_swap_jpm.py --dry-run
    python 02_21_daily_settlement_eventos_swap_jpm.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/daily settlement/eventos-swap-jpm (arquivo-dia)')
    ...
    fatia = 'daily settlement/eventos-swap-jpm'
    if args.bloco:
