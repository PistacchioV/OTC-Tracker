...
Uso:
    ...
    python 02_2_new_deals_ndf_fwdstart.py --dry-run
    python 02_2_new_deals_ndf_fwdstart.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/new deals/NDF/FwdStart (arquivo-dia)')
