...
Uso:
    python 02_4_pending_confirmation.py
    python 02_4_pending_confirmation.py --dry-run
    python 02_4_pending_confirmation.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    _resumo('daily', convert_daily(data_dir, out_dir, force=args.force,
                                   dry_run=args.dry_run, familias=['pending-confirmation']),
            houve_erro)
