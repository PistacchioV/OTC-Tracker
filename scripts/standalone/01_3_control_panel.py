#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 01_control_panel — a pasta de cadastro `control-panel`.
...
Uso:
    ...
    python 01_3_control_panel.py --dry-run
    python 01_3_control_panel.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"

O ESCOPO é UMA pasta de cadastro do DATA_DIR: **control-panel\**.

O estado das rotinas do Control Panel.

É UM BANCO POR ARQUIVO, na mesma árvore do JSON (db\control-panel\<arquivo>.db),
...
def main(argv=None):
    ...
    print('escopo : control-panel/ (um banco por arquivo)')
    ...
    _resumo('datasets', convert_datasets(data_dir, out_dir, force=args.force,
                                         ...
                                         pastas=['control-panel']), houve_erro)
