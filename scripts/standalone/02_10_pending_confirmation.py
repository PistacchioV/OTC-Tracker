...
Uso:
    python 02_10_pending_confirmation.py
    python 02_10_pending_confirmation.py --dry-run
    python 02_10_pending_confirmation.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
