...
Uso:
    python 02_9_daily_settlement.py
    python 02_9_daily_settlement.py --dry-run
    python 02_9_daily_settlement.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
