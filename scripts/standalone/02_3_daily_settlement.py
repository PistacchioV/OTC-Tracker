#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_daily_settlement — a rotina `daily settlement` de cache/.
...
Uso:
    python 02_3_daily_settlement.py
    python 02_3_daily_settlement.py --dry-run
    python 02_3_daily_settlement.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/daily settlement (arquivo-dia)')

    houve_erro = [False]
    _resumo('daily', convert_daily(data_dir, out_dir, force=args.force,
                                   dry_run=args.dry_run, familias=['daily settlement'],
                                   desde=desde),
            houve_erro)
