#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_new_deals_option — a rotina `new deals/Option` de cache/.
...
Uso:
    python 02_2_new_deals_option.py
    python 02_2_new_deals_option.py --dry-run
    python 02_2_new_deals_option.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/new deals/Option (arquivo-dia)')
