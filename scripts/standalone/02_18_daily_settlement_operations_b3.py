#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_daily_settlement_operations_b3 — a rotina `daily settlement/operations-b3` de cache/.
...
Uso:
    ...
    python 02_18_daily_settlement_operations_b3.py --dry-run
    python 02_18_daily_settlement_operations_b3.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/daily settlement/operations-b3 (arquivo-dia)')
    ...
    fatia = 'daily settlement/operations-b3'
    if args.bloco:
