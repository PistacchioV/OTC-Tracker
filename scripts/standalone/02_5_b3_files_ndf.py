#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_b3_files_ndf — a rotina `b3 files/NDF` de cache/.
...
Uso:
    python 02_5_b3_files_ndf.py
    python 02_5_b3_files_ndf.py --dry-run
    python 02_5_b3_files_ndf.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/b3 files/NDF (arquivo-dia)')
