#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_new_deals_intrag_option — a rotina `new deals/Intrag/Option` de cache/.
...
Uso:
    ...
    python 02_10_new_deals_intrag_option.py --dry-run
    python 02_10_new_deals_intrag_option.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/new deals/Intrag/Option (arquivo-dia)')
