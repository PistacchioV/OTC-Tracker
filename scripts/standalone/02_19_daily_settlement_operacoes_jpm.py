#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_daily_settlement_operacoes_jpm — a rotina `daily settlement/operacoes-jpm` de cache/.

As operações JPM/MGT.
...
Uso:
    ...
    python 02_19_daily_settlement_operacoes_jpm.py --dry-run
    python 02_19_daily_settlement_operacoes_jpm.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"
...
def main(argv=None):
    ...
    print('escopo : cache/daily settlement/operacoes-jpm (arquivo-dia)')
    ...
    fatia = 'daily settlement/operacoes-jpm'
    if args.bloco:
