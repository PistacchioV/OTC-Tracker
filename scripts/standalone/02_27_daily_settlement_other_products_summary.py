#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_daily_settlement_other_products_summary — a rotina `daily settlement/other-products-summary` de cache/.
...
def main(argv=None):
    ...
    print('escopo : cache/daily settlement/other-products-summary (arquivo-dia)')
    ...
    fatia = 'daily settlement/other-products-summary'
    if args.bloco:
