...
def main(argv=None):
    ...
    _resumo('daily', convert_daily(data_dir, out_dir, force=args.force,
                                   dry_run=args.dry_run, excluir=['new deals/NDF', 'new deals/Option', 'new deals/Swap', 'new deals/Intrag', 'b3 files/NDF', 'b3 files/Option', 'b3 files/Swap', 'b3 files/Operations', 'daily settlement', 'pending-confirmation', 'payrec', 'reconciliation'],
                                   desde=desde),
            houve_erro)
