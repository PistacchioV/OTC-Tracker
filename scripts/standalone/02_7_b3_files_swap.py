#!/usr/bin/env python3
# -*- coding: utf-8 -*-
r"""convert 02_b3_files_swap — a rotina `b3 files/Swap` de cache/.

Idem, para os swaps — costuma ser o maior dos quatro.
...
Uso:
    python 02_7_b3_files_swap.py
    python 02_7_b3_files_swap.py --dry-run
    python 02_7_b3_files_swap.py --data-dir "D:\outra\pasta" --out-dir "D:\saida"

O ESCOPO é UM bloco de cache\: **b3 files/Swap**.
...
def main(argv=None):
    ...
    print('escopo : cache/b3 files/Swap (arquivo-dia)')
