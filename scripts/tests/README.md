...
| `check_ndf_advice.py` | Settlement Advice de **NDF Commodities**: o universo de três peneiras (Resgate · TER · Type COMMODITIES), o join do OTM pelo **sufixo depois do hífen** (os prefixos diferem entre os sistemas), o IR de 0,005% só quando o banco paga com LAWTON isenta, e a Cotação Mercadoria da asiática virando `Média Fev/2027` | `_ndfadv_collect`/`_subjacente_map`/`_ndfadv_otm_by_suffix` ou `other-products-ndf-settlement-advice.html` (§194) |
