...
# O motor mora em platform/settlement.py (§316); o routes entra junto para a
# asserção negativa (nenhuma cópia com literal pode ter ficado para trás).
src = (open(os.path.join(ROOT, 'apps', 'pages', 'routes.py'), encoding='utf-8').read()
       + open(os.path.join(ROOT, 'apps', 'pages', 'platform', 'settlement.py'),
              encoding='utf-8').read())
