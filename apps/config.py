...
class Config(object):
    ...
    _DATA_DIR_DEFAULT = os.path.join(_JPM_APP_ROOT, 'static', 'data')
    ...
    _CONECTA_SUFFIX = ''         # Batch Conecta: a prod grava em New / lê Return
    _FOUR_EYES = True            # maker/checker OBRIGATÓRIO na prod
    # ── /ENV ─────────────────────────────────────────────────────────────────
