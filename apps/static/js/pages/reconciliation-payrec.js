...
(function () {
  ...
  var _TRANS = {
    en: { running: 'Running…', sending: 'Sending…', run: 'Run reconciliation', end: 'End process',
          ...
          confirmEnd: 'Send the final Pay/Rec situation of the day to OTC Ops (Danilo & Renato in copy)?',
    ...
    br: { running: 'Processando…', sending: 'Enviando…', run: 'Rodar reconciliação', end: 'Encerrar processo',
          ...
          confirmEnd: 'Enviar a situação final do Pay/Rec do dia para a OTC Ops (Danilo e Renato em cópia)?',
    ...
    es: { running: 'Procesando…', sending: 'Enviando…', run: 'Ejecutar reconciliación', end: 'Finalizar proceso',
          ...
          confirmEnd: '¿Enviar la situación final de Pay/Rec del día a OTC Ops (Danilo y Renato en copia)?',
