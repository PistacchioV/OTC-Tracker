...
document.addEventListener('DOMContentLoaded', function() {
    // Stepline Chart
    var steplineChart = new ApexCharts(document.querySelector('#line-chart-stepline'), {
        chart: {
            type: 'line',
            height: 360,
            toolbar: { show: false }
        ...
        colors: ['#800080'], // Replaced ins('purple') with hex code
        markers: {
            hover: {
                sizeOffset: 4
            }
    ...
    // Area Chart with Brush (#chart-line)
    new CustomApexChart({
        selector: '#chart-line',
        options: () => ({
            series: [{
