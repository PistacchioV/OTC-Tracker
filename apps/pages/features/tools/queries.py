...
def swap_prefill(b3_id):
    ...
    for k, lado in enumerate(('ativa', 'passiva')):
        ...
        # (`swap_flows.taxa_do_fluxo`). Só quando a posição não respondeu:
        # vazio ali seria lido como 0%, e um spread negativo sumiria da conta
        # sem aviso. A posição VENCE quando tem taxa — no 25C04803529 ela dizia
        # − 11,95%, e era ela a certa (a planilha que parecia desmenti-la estava
        # sem esse spread).
        taxa_do_fluxo = False
